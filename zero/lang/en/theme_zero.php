...
/**
 * Strings for component 'theme_zero', language 'en'
 *
 * @package   theme_zero
...
<div class="well">
<h2>Zero</h2>
<p><img class=img-polaroid src="zero/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>Zero is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="zero/README.txt">How to copy and customise this theme.</a></p>
</div></div>';

$string['configtitle'] = 'Zero';
$string['choosereadme'] = 'Zero, a Moodle 2.8+ theme by OC Dev Team.';
