	...
	<div class="container-fluid hidden-phone" id="logo-oc">
		<img id="zero-uwi-logo" title='University of the West Indies, Open Campus' src='<?php echo $CFG->wwwroot."/theme/".current_theme() ?>/pix/zero/logo-uwi-trans-<?php echo $PAGE->theme->settings->campus; ?>.png' height="72"/>
	</div>
