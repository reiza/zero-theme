				...
				<div class="container">
					<div class="row-fluid ">
						...
						<div class="social copyright span6 pull-left">
							&copy; <a href="http://<?php echo $displayCampus[1]; ?>">2014 UWI <?php echo $displayCampus[0]; ?></a>. All Rights Reserved. | <?php echo gethostname(); ?>.
							<!-- 
								| <a href="#">Disclaimer</a> 
								| <a href="#">Privacy Statement</a>  
								| <a href="#">UWI ICT Policies</a>   
								-->
							</div>
							...
							<div class="social copyright span6 pull-right">
								...
								<img class="hidden-phone pull-right" src="<?php echo $CFG->wwwroot."/theme/".current_theme() ?>/pix/zero/flags.png" alt="National Flags of the UWI Contributing Countries" usemap="#Map" />							
							</div><!--//social-->
						</div><!--//row-->
					</div><!--//container-->
				</div>
